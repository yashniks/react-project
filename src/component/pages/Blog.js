            ...
            <div class="col-sm-12 blog clearfix">
              <div class="col-sm-9 blog_left">
                <div class="col-sm-12 blog_left_inner">
                  <h1>
                    <span class="boat">BLO</span>G
                  </h1>
                  <h3>
                    <a href="#">Sed cursus ante dapibus diam. Sed</a>
                  </h3>
                  <h5>
                    October 5, 2016 | <a href="#">No Comments </a>| Categories:{" "}
                    <a href="#">Adipiscingelit</a>
                  </h5>
                </div>
                <div class="col-sm-12 blog_left_middle">
                  ...
                  <div class="col-sm-10 blog_left_middle_2">
                    <p>
                      ...
                      Sed dignissim lacinia nunc Sed cursus ante dapibus diam.
                ...
                <div class="col-sm-12 blog_left_inner">
                  <h3>
                    <a href="#">Ipsum dolor sit amet, consectetur adipiscing</a>
                  </h3>
                  <h5>
                    October 5, 2016 | <a href="#">No Comments </a>| Categories:{" "}
                    <a href="#">Adipiscingelit</a>
              ...
              <div class="col-sm-3 about_1_right clearfix">
                ...
                <div class="col-sm-12 about_1_right_center clearfix">
                  ...
                  <div class="about_1_right_center_2">
                    <ul>
                      <li>
                        <a href="#">Praesent mauris. Fusce nec tellus</a>
                      </li>
                      <li>
                        <a href="#">
                      ...
                      <li>
                        <a href="#">
                          Integer nec odionec odio. Praesent libero
                        </a>
                      </li>
                      <li class="hello">
                ...
                <div class="col-sm-12 about_1_right_center clearfix">
                  ...
                  <div class="about_1_right_center_2 clearfix">
                    <ul>
                      <li class="word">
                        <a href="#">Fusce tellus sed augue semper porta!</a>
                      </li>
                    </ul>
                  </div>
                </div>
                ...
                <div class="col-sm-12 about_1_right_center clearfix">
                  ...
                  <div class="about_1_right_center_2">
                    <ul>
                      ...
                      <li>
                        <a href="#">Odionec odio</a>
                      </li>
                      <li class="hello">
                        <a href="#">Wellussed.org</a>
                      </li>
                    </ul>
                  </div>
                </div>
